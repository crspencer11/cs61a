...
class VendingMachine:
    ...
    def add_funds(self, price):
        if self.stock == 0:
            return("Machine is empty. Please restock. Here is your ${0}.".format(price))
        self.balance += price
...
def path_yielder(t, value):
    ...
    if t.label is value:
        yield [value]
    for b in t.branches:
        for new_path in path_yielder(b, value):
            yield [t.label] + new_path
    "*** YOUR CODE HERE ***"
