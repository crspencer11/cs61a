...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    return sqrt(square(get_lat(city_a) - get_lat(city_b)) + square(get_lon(city_a) - get_lon(city_b)))
...
def sprout_leaves(t, leaves):
    ...
    "*** YOUR CODE HERE ***"
    if is_leaf(t):
        return tree(label(t), [tree(_) for _ in leaves])
    else:
        leaves = [sprout_leaves(b, leaves) for b in branches(t)]
